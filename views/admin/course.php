                ...
                <tr>
                  ...
                  <td>
                    ...
                    <?php elseif ($data['deleted'] == 1) : ?>
                      <button class="btn btn-danger" data-target="#retreive<?= $data['course_id'] ?>" data-toggle="modal">Retrieve Course</button>
                  ...
                  <!--  Edit -->
                      <!-- Retreive -->
                      <div class="modal fade" id="retreive<?= $data['course_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form action="./course/retreive_courses.php?old=<?= $data['course_id'] ?>" method="POST">
                          <div class="modal-body">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            <button type="submit" name="delete" class="btn btn-primary">Update</button>
                          </div>
                        </form>
                      </div>
                    </div>
