...
<html lang="en">
  ...
  <div class="modal-dialog" role="document">
    ...
    <div class="form-floating mb-3">
     ...
     <div class="form-floating mb-3">
      <label for="floatingInput">section</label>
        <input type="text" class="form-control" id="floatingInput" name="course_id" placeholder="Work Time">
    </div>

    <div class="form-floating mb-3">
      <label for="floatingInput">Language</label>
      <select class="form-control" name="major_id" placeholder="Select Language">
            <option>TH</option>
            <option>ENG</option>
            </select>
    </div>
