      ...
      <div id="register" class="animate form registration_form">
        <section class="login_content">
          <form action="register.php" method="POST">
            ...
            <div>
              <input type="email" required class="form-control" pattern="[a-z0-9._%+-]+@cmu.ac.th" placeholder="อีเมลล์นักศึกษา" required="" name="cmu_email" />
            </div>
            <div>
            ...
            <div>
              <input type="text" required class="form-control" placeholder="Portfolio link" required="" name="portfolio" />
            </div>
