...
-- Dumping database structure for tasys2
CREATE DATABASE IF NOT EXISTS `tasys2` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `tasys2`;

-- Dumping structure for table tasys2.course
...
-- Dumping structure for table tasys2.day_work
...
-- Dumping structure for table tasys2.major
...
-- Dumping structure for table tasys2.matching_course
...
-- Dumping structure for table tasys2.matching_ta
...
-- Dumping structure for table tasys2.register
...
-- Dumping structure for table tasys2.semester
...
-- Dumping structure for table tasys2.ta_request
...
-- Dumping structure for table tasys2.user_tbl
